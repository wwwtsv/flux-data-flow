...
},{"buffer":"../node_modules/buffer/index.js"}],"store/index.ts":[function(require,module,exports) {
"use strict";
...
var Store = /*#__PURE__*/function () {
  ...
  _createClass(Store, [{
    ...
    value: function areEqual(one, two) {
      return lodash_1.isEqual(one, two);
    }
  }]);
...
var FileStore = /*#__PURE__*/function (_Store) {
  ...
  var _super = _createSuper(FileStore);

  function FileStore(state, reducer) {
    _classCallCheck(this, FileStore);

    return _super.call(this, state, reducer);
  }
  ...
  _createClass(FileStore, [{
    ...
    value: function dispatch(action) {
      ...
      if (!_get(_getPrototypeOf(FileStore.prototype), "areEqual", this).call(this, this.state, newState)) {
    ...
    value: function emitChange() {
      ...
      this.subscribers.forEach(function (subscriber) {
        return subscriber.rerender(_this.state);
      });
    }
  }]);
...
},{"lodash":"../node_modules/lodash/lodash.js"}],"actions/types.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getSearchFiles = exports.Actions = void 0;
var Actions;

(function (Actions) {
  Actions["CHANGE_VALUE"] = "change-value";
})(Actions = exports.Actions || (exports.Actions = {}));

var getSearchFiles = function getSearchFiles(fileList) {
  return {
...
exports.getSearchFiles = getSearchFiles;
},{}],"view/index.ts":[function(require,module,exports) {
"use strict";
...
var SearchFileView = /*#__PURE__*/function () {
  function SearchFileView() {
    _classCallCheck(this, SearchFileView);

    this.layout = SearchFileView.createLayout();
  }

  _createClass(SearchFileView, [{
    key: "searchFileHandler",
    value: function searchFileHandler(element, store) {
      ...
      if (inputElement) {
        inputElement.addEventListener("change", function (e) {
          ...
          var _store$getState = store.getState(),
              files = _store$getState.files;

          var filteredFiles = files.filter(function (file) {
            return file.includes(value);
          });
          store.dispatch(types_1.getSearchFiles(filteredFiles));
        });
      }
    }
  }, {
    ...
    value: function rerender(state) {
      if (this.searchFileList) {
        ...
        lodash_1.isEmpty(state.filteredFiles) ? this.searchFileList.insertAdjacentHTML("afterbegin", "<li>Файл не найден...</li>") : this.generateFileList(state.filteredFiles, this.searchFileList);
      }
    }
  }, {
    key: "generateFileList",
    value: function generateFileList(files, container) {
      files.forEach(function (file) {
        var fileListElem = document.createElement("li");
...
exports.default = SearchFileView;
},{"../actions/types":"actions/types.ts","lodash":"../node_modules/lodash/lodash.js"}],"actions/index.ts":[function(require,module,exports) {
"use strict";
...
var searchReducer = function searchReducer(state, action) {
  switch (action.type) {
    case types_1.Actions.CHANGE_VALUE:
      {
...
},{"./types":"actions/types.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var app = new view_1.default();
var store = new store_1.default(initialState, actions_1.default);
store.subscribe(app);
app.render(store.getState());
app.searchFileHandler("search-input", store);
},{"./store":"store/index.ts","./view":"view/index.ts","./actions":"actions/index.ts"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
